package com.example.projectdodawifi;
        ...
        public void run() {
            ...
            while (socket != null && !socket.isClosed()) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "Connection lost: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    break; // ループを抜けて接続を終了
                }
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // パーミッションが許可された場合、Wi-Fiの操作を続行可能
            } else {
                // パーミッションが拒否された場合、機能が制限されることを通知
            }
        }
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if (sendReceive != null) {
                    ...
                    // Handle the case where sendReceive is not yet initialized
